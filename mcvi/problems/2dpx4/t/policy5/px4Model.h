...
enum observations {ObsNothing, Crash, Left, Right};
...
class px4Model : public Model
{
  public:
   ...
   double getMaxReward() { return 0;};

    // double getMinReward() { return CollisionPenalty;};
   double getMinReward() { return -100;};
