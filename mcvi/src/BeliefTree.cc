...
// we choose action a that leads to the child node with the highest upper bound 
// and choose observation o that leads to the child node 
// making the largest contribution to the gap between the upper and lower bounds 
// at the root of TR
